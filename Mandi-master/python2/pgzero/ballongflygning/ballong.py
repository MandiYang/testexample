'''Det finns två lufthinder och två markhiner, du är ballongen som ska styra dig förbi alla hinder'
...
def uppdatera_rekord():
    global summa, summor
    filnamn = r"/home/mandi/Desktop/Mandi-master/python2/pgzero/ballongflygning/rekord.txt"
    summor = []
